...
public class Level1Activity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if(isAnswered == false){
                    if(selectedButton == btnChoice1 || selectedButton == btnChoice2
                        ...
                        Toast.makeText(Level1Activity.this, "Please select an option", Toast.LENGTH_SHORT).show();
    ...
    private void showNewQuestion(){
        ...
        if(questionCount < totalQuestion){
            Timer();  // Start the timer as the question starts
            ...
            clockTickSound.stop();   // stop the current playing sound
            if(selectedButton==null ){    // if user do not answer last question in time, it will automatically move to result activity
                tvLevel.setText("Level 1");   // to pass the string for level checking on result activity
                Intent intent = new Intent(Level1Activity.this, End_Activity.class);
    ...
    private void Timer(){
        countDownTimer = new CountDownTimer(20000,1000) {  // count for 20 seconds
            @Override
            public void onTick(long l) {
                ...
                if (l <= 1000 && selectedButton == null) {         // time is about to over and user didn't answer
                    ivImage.setImageResource(R.drawable.prof_angry);
                    wrongSound.start();
                }
            }
            @Override
            public void onFinish() {   // move to another question when time is up
                showNewQuestion();
            }
        }.start();
    }
